 ...
 <!-- 23. blog_area -->
	<div class="blog_area sp">
		<div class="container">
			<div class="row">
			    <div class=" post_col">
			        <div class="row isotop-active gallery">
                        <?php if(have_posts()) : ?>
							...
							<article class="col-md-12 wow fadeInUp">
								<?php the_posts_pagination(
									array(
									'prev_text' => esc_html__('Prev','blogzen'),
									'next_text' => esc_html__('Next','blogzen')
									)
								); ?>
							</article>	
						<?php else : ?>
							<p><?php esc_html__('No Posts Found', 'blogzen'); ?></p>
						 <?php endif; ?>
                     </div>
			    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 text-right">
					...
					<?php echo esc_html($ctah_btn_text2); ?></a>
                </div>
				<?php } ?>
            </div>
        </div>
