...
if ( ! class_exists( 'Glowline_Demo' ) ) {
	...
	class Glowline_Demo {
		...
		/**
		 * Singleton instance of Glowline_Demo.
		 *
		 * @var Glowline_Demo $instance Glowline_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Glowline_Demo ) ) {
				self::$instance = new Glowline_Demo();
